...
use Grade\WebBundle\Form\GradeType;
...
class GradeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GradeWebBundle:Grade')->findAll();
     ...
     * @Method("POST")
     * @Template("GradeWebBundle:Grade:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GradeWebBundle:Grade')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GradeWebBundle:Grade:edit.html.twig")
     */
